...
if [ -f /usr/bin/fastfetch ]; then
	fastfetch -l ~/.config/fastfetch/arch.txt --logo-position left
        #fastfetch --logo-position left
...
alias ll='ls -alF --group-directories-first --color=auto'                # long listing format
...
# my aliases
alias wifi='nmcli device wifi connect "404 Page Not Found" --ask'
